...
var playlist : Dictionary = {
	"menu": preload("res://assets/music/ES_Albatross - Lexica.ogg"),
	"pause": preload("res://assets/music/ES_Mango Fizz - Jobii.ogg"),
	"game": preload("res://assets/music/ES_Nintendo Revolution - Rolla Coasta.ogg"),
	"level_complete": preload("res://assets/music/ES_Fair N Square - William Benckert.ogg"),
	"game_over": preload("res://assets/music/ES_Ctrl Alt Defeat - Deskant.ogg"),
	"shop": preload("res://assets/music/ES_Before Chill - Yomoti.ogg"),
	"win": preload("res://assets/music/ES_Goodbye Goodnight - One Two Feet.ogg"),
}
